...
function ferma_apply_single_post_header_fixes() {
	...
	$css = '@media (min-width: 868px){'
		...
		. 'body.single.single-post .header__desktop-menu{margin:40px 0 !important;padding:26px !important;background-color:#fdf5e5 !important;border-radius:12px !important;color:var(--color-light-black) !important;}'
		. 'body.single.single-post .header__desktop-menu nav ul{justify-content:center !important;gap:64px !important;}'
		. 'body.single.single-post .header__desktop-menu nav ul li a{color:var(--color-light-black) !important;font-size:var(--font-sz-18) !important;font-weight:var(--font-w-regular) !important;text-decoration:none !important;}'
