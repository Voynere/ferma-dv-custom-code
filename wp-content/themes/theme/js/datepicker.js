!(function (e, t) {
    ...
    function v(t) {
        for (var n = Array.prototype.slice.call(arguments, 1), i = 0; i < n.length; i++)
            for (var a in n[i])
                void 0 !== t[a] && "object" === e(n[i][a]) && null !== n[i][a] && void 0 === n[i][a].nodeName
                    ? (n[i][a] instanceof Date && (t[a] = new Date(n[i][a].getTime())), Array.isArray(n[i][a]) ? (t[a] = n[i][a].slice(0)) : (t[a] = v(t[a], n[i][a])))
                    : (t[a] = n[i][a]);
        return t;
    }
    function _(e, t, n) {
            ...
            n(e, [
                {
                    ...
                    value: function () {
                        ...
                        this._set = { openOn: r, inline: n, weekstart: s, min: i, max: i, within: a, without: a, defaultTime: o, classNames: l, templates: u };
                ...
                },
                {
                    ...
                    value: function (e, t) {
                        if (e) {
                            if (m(e)) {
                                for (var n in ((this._noRender = !0), e.serialize && (this.set("serialize", e.serialize), delete e.serialize), e.deserialize && (this.set("deserialize", e.deserialize), delete e.deserialize), e))
                                    this.set(n, e[n]);
                ...
                },
                {
                    ...
                    value: function (e) {
                        ...
                        "string" == typeof (e = e || this._opts.openOn || this._month) &&
                            ("first" === (e = e.toLowerCase()) && t.length ? (e = t[0]) : "last" === e && t.length ? (e = t[t.length - 1]) : "today" !== e && (e = this._opts.deserialize(e))),
                            p(e) || (e = new Date()),
                ...
                },
                {
                    ...
                    value: function (e, t) {
                        ...
                        return (
                            (e = f(p(e) ? e : o(e))),
                            "month" == t
                                ? ((h = !i || e.getMonth() >= i.getMonth()), (l = !a || e.getMonth() <= a.getMonth()))
                                : "year" == t
                                ? ((h = !i || e.getFullYear() >= i.getFullYear()), (l = !a || e.getFullYear() <= a.getFullYear()))
                                : ((h = !i || e >= i), (l = !a || e <= a)),
                ...
                },
                {
                    ...
                    value: function () {
                        ...
                        return { _date: g, index: e, year: v, month: n.months[m], days: w, weekdays: n.weekdays, hasNext: !s || _ <= s, hasPrev: !r || y >= r };
                    },
                },
                {
                    key: "_renderHeader",
                        ...
                        return this._renderers.header(
                            i({}, e, {
                                renderMonthSelect: function () {
                                    for (var e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : o, n = new Date(s.getTime()), i = [], a = 0; a < 12; a++)
                                        n.setMonth(a), i.push({ text: r.months[a], disabled: !t.dateAllowed(n, "month"), selected: a === h, value: a });
                                    return t._renderers.select({ index: e, type: "month", text: r.months[h], value: h, options: i });
                                },
                                renderYearSelect: function () {
                                    for (var e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : o, n = new Date(s.getTime()), i = l - a, r = l + a, h = []; i <= r; i++)
                                        n.setFullYear(i), h.push({ disabled: !t.dateAllowed(n, "year"), selected: i === l, value: i, text: i });
                            ...
                            return (
                                ...
                                this._renderers.timepicker({
                                    ...
                                    renderHourSelect: function () {
                                        for (var n = arguments.length > 0 && void 0 !== arguments[0] && arguments[0], i = [], a = s[0], r = n ? 24 : 12, o = 0; o < r; o++)
                                            i.push({ text: n || o ? o : "12", selected: a === o, disabled: !1, value: o });
                                        !n && a >= 12
                                    ...
                                    renderMinuteSelect: function () {
                                        for (var n = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : 15, i = [], a = 0; a < 60; a += n) i.push({ text: a < 10 ? "0" + a : a, selected: s[1] === a, disabled: !1, value: a });
