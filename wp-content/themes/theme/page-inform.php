...
* Для страниц: политика конфиденциальности, пользовательское соглашение, правила возврата.
*/
?>


<?php get_header('home'); ?>
<main class="page-inform">
    ...
    <section class="page-inform__body">
        <div class="container">
            <div class="page-inform__inner">
                <h1 class="recipe__title page-title"><?php echo esc_html( get_the_title() ); ?></h1>
                <div class="page-inform__content">
                    <?php the_post(); ?>
                    <?php the_content(); ?>
                </div>
            </div>
