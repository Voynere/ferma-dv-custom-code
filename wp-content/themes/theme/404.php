    ...
    <section class="error-page">
        <div class="container">
            <div class="error-page__inner">
                <h1 class="error-page__title">Ошибка 404<br>Страница не найдена!</h1>
                <p class="error-page__text">
                    Запрашиваемая Вами страница или документ отсутствуют.<br>
                </p>
                <a class="error-page__link" href="<?php echo get_home_url(); ?>/">Вернуться на главную страницу</a>
            </div>
        </div>
    </section>
