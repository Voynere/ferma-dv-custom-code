    ...
    <ul class="woocommerce-mini-cart cart_list product_list_widget cart__body">
        ...
        foreach (WC()->cart->get_cart() as $cart_item_key => $cart_item) {
                    ...
                    <div class="cart__item-content">
                        <div class="cart__item-product">
                            ...
                            <div class="cart__item-container">
                                ...
                                <?php
                                $quantity   = $cart_item['quantity'];               // 1,2,3 – шаги
                                $price_unit = wc_get_price_to_display( $_product ); // цена за шаг (0.1 кг)
                                $total      = $quantity * $price_unit;

                                // коэффициент веса из общей функции
                                $weight_ratio     = function_exists('get_weight_ratio') ? get_weight_ratio( $product_id ) : 1;
                                $is_weight_product = ( $weight_ratio < 1 ); // если 0.1 – весовой товар

                                // что показываем рядом с +/-:
                                // ВСЕГДА показываем целое число шагов (1, 2, 3...)
            ...
            <?php echo esc_html( $qty_display ); ?>
                                        ...
                                        <button type="button" class="cart__qty-btn cart__qty-btn--plus" aria-label="Увеличить количество">+</button>
                                    </div>
                                    ...
                                    <div class="cart__item-calc-sum">
                                        ...
                                        if ( $is_weight_product ) {
                                            ...
                                            $price_per_kg = $weight_ratio > 0 ? ( $price_unit / $weight_ratio ) : 0;
