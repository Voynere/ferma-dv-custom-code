...
function ferma_apply_internal_header_layout_fixes() {
	...
	$css = '@media (min-width: 868px){'
		. 'body.single.single-post .header__desktop-bot,body.single-post .header__desktop-bot,body.archive .header__desktop-bot,body.category .header__desktop-bot,body.blog .header__desktop-bot,body.tax-product_cat .header__desktop-bot,body.post-type-archive-product .header__desktop-bot,body.tax-product_cat .header__product .header__desktop-bot,body.post-type-archive-product .header__product .header__desktop-bot,.header.header__product .header__desktop-bot{display:flex !important;margin-top:24px !important;}'
