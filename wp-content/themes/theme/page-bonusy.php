...
<main class="page-bonusy">
    ...
    <div class="page-bonusy__body">
        <div class="container">
            <div class="page-bonusy__inner">
                <h1 class="page-bonusy__title page-title">БОНУСНАЯ ПРОГРАММА</h1>
                <div class="page-bonusy__content">
                <?php
                    the_content();
                ?>
            </div>
