...
<div class="container-fluid" style="background: #68aa2f;">
    <div class="container footer_ferma">
        <div class="row">
            ...
            <div class="col-12 col-lg-3 d-none d-lg-block">
                ...
                <a href="https://ferma-dv.ru/product-category/bakaleya/<?
	...
	?>">Бакалея</a>
                <a href="https://ferma-dv.ru/product-category/varene/<?
	$cur_user_id = get_current_user_id();
	$user_info = get_userdata($cur_user_id);
		if($user_info->user_market == "ГринМаркет ТЦ Море" or $_COOKIE["market"] == "ГринМаркет ТЦ Море") {
		echo "?wms-addon-store-filter-form%5B0%5D=cab1caa9-da10-11eb-0a80-07410026c356";
	...
	?>">Варенье, домашние соки и компоты</a>
                <a href="https://ferma-dv.ru/product-category/domashnie-syry/<?
	$cur_user_id = get_current_user_id();
	$user_info = get_userdata($cur_user_id);
		if($user_info->user_market == "ГринМаркет ТЦ Море" or $_COOKIE["market"] == "ГринМаркет ТЦ Море") {
		echo "?wms-addon-store-filter-form%5B0%5D=cab1caa9-da10-11eb-0a80-07410026c356";
	...
	?>">Домашние сыры</a>
                <a href="https://ferma-dv.ru/product-category/domashnyaya-konservacziya/<?
	$cur_user_id = get_current_user_id();
	$user_info = get_userdata($cur_user_id);
		if($user_info->user_market == "ГринМаркет ТЦ Море" or $_COOKIE["market"] == "ГринМаркет ТЦ Море") {
		echo "?wms-addon-store-filter-form%5B0%5D=cab1caa9-da10-11eb-0a80-07410026c356";
	...
	?>">Домашняя консервация</a>
                <a href="https://ferma-dv.ru/product-category/kolbasy/<?
	$cur_user_id = get_current_user_id();
	$user_info = get_userdata($cur_user_id);
		if($user_info->user_market == "ГринМаркет ТЦ Море" or $_COOKIE["market"] == "ГринМаркет ТЦ Море") {
		echo "?wms-addon-store-filter-form%5B0%5D=cab1caa9-da10-11eb-0a80-07410026c356";
	...
	?>">Колбасы</a>
                <a href="https://ferma-dv.ru/product-category/kopchenosti/<?
	$cur_user_id = get_current_user_id();
	$user_info = get_userdata($cur_user_id);
		if($user_info->user_market == "ГринМаркет ТЦ Море" or $_COOKIE["market"] == "ГринМаркет ТЦ Море") {
		echo "?wms-addon-store-filter-form%5B0%5D=cab1caa9-da10-11eb-0a80-07410026c356";
	...
	?>">Копчености</a>
				<a href="https://ferma-dv.ru/product-category/med/<?
	$cur_user_id = get_current_user_id();
	$user_info = get_userdata($cur_user_id);
		if($user_info->user_market == "ГринМаркет ТЦ Море" or $_COOKIE["market"] == "ГринМаркет ТЦ Море") {
		echo "?wms-addon-store-filter-form%5B0%5D=cab1caa9-da10-11eb-0a80-07410026c356";
	...
	?>">Мед</a>
                <a href="https://ferma-dv.ru/product-category/molochnaya-produkcziya/<?
	$cur_user_id = get_current_user_id();
	$user_info = get_userdata($cur_user_id);
		if($user_info->user_market == "ГринМаркет ТЦ Море" or $_COOKIE["market"] == "ГринМаркет ТЦ Море") {
		echo "?wms-addon-store-filter-form%5B0%5D=cab1caa9-da10-11eb-0a80-07410026c356";
	...
	?>">Молочная продукция</a>
                <a href="https://ferma-dv.ru/product-category/myaso/<?
	$cur_user_id = get_current_user_id();
	$user_info = get_userdata($cur_user_id);
		if($user_info->user_market == "ГринМаркет ТЦ Море" or $_COOKIE["market"] == "ГринМаркет ТЦ Море") {
		echo "?wms-addon-store-filter-form%5B0%5D=cab1caa9-da10-11eb-0a80-07410026c356";
	...
	?>">Мясо</a>
                <a href="https://ferma-dv.ru/product-category/ovoshhi/<?
	$cur_user_id = get_current_user_id();
	$user_info = get_userdata($cur_user_id);
		if($user_info->user_market == "ГринМаркет ТЦ Море" or $_COOKIE["market"] == "ГринМаркет ТЦ Море") {
		echo "?wms-addon-store-filter-form%5B0%5D=cab1caa9-da10-11eb-0a80-07410026c356";
	...
	?>">Овощи, фрукты, ягоды</a>
				<a href="https://ferma-dv.ru/product-category/podarochnye-nabory/<?
	$cur_user_id = get_current_user_id();
	$user_info = get_userdata($cur_user_id);
		if($user_info->user_market == "ГринМаркет ТЦ Море" or $_COOKIE["market"] == "ГринМаркет ТЦ Море") {
		echo "?wms-addon-store-filter-form%5B0%5D=cab1caa9-da10-11eb-0a80-07410026c356";
	...
	?>">Подарочные наборы</a>
                <a href="https://ferma-dv.ru/product-category/polufabrikaty-domashnie/<?
	$cur_user_id = get_current_user_id();
	$user_info = get_userdata($cur_user_id);
		if($user_info->user_market == "ГринМаркет ТЦ Море" or $_COOKIE["market"] == "ГринМаркет ТЦ Море") {
		echo "?wms-addon-store-filter-form%5B0%5D=cab1caa9-da10-11eb-0a80-07410026c356";
	...
	?>">Полуфабрикаты домашние</a>
                <a href="https://ferma-dv.ru/product-category/remeslennyj-hleb-i-vypechka/<?
	$cur_user_id = get_current_user_id();
	$user_info = get_userdata($cur_user_id);
		if($user_info->user_market == "ГринМаркет ТЦ Море" or $_COOKIE["market"] == "ГринМаркет ТЦ Море") {
		echo "?wms-addon-store-filter-form%5B0%5D=cab1caa9-da10-11eb-0a80-07410026c356";
	...
	?>">Ремесленный хлеб и выпечка</a>
				<a href="https://ferma-dv.ru/product-category/sladosti-i-deserty/<?
	$cur_user_id = get_current_user_id();
	$user_info = get_userdata($cur_user_id);
		if($user_info->user_market == "ГринМаркет ТЦ Море" or $_COOKIE["market"] == "ГринМаркет ТЦ Море") {
		echo "?wms-addon-store-filter-form%5B0%5D=cab1caa9-da10-11eb-0a80-07410026c356";
	...
	?>">Сладости и десерты</a>
                <a href="https://ferma-dv.ru/product-category/tushenka-i-kashi-sobstvennoe-proizvodstvo/<?
	$cur_user_id = get_current_user_id();
	$user_info = get_userdata($cur_user_id);
		if($user_info->user_market == "ГринМаркет ТЦ Море" or $_COOKIE["market"] == "ГринМаркет ТЦ Море") {
		echo "?wms-addon-store-filter-form%5B0%5D=cab1caa9-da10-11eb-0a80-07410026c356";
	...
	?>">Тушенки и каши собственное производство</a>
                <a href="https://ferma-dv.ru/product-category/chaj-travy-i-dikorosy/<?
	$cur_user_id = get_current_user_id();
	$user_info = get_userdata($cur_user_id);
		if($user_info->user_market == "ГринМаркет ТЦ Море" or $_COOKIE["market"] == "ГринМаркет ТЦ Море") {
		echo "?wms-addon-store-filter-form%5B0%5D=cab1caa9-da10-11eb-0a80-07410026c356";
	...
	?>">Чай, травы и дикоросы</a>
                <a href="https://ferma-dv.ru/product-category/yajczo/<?
	$cur_user_id = get_current_user_id();
	$user_info = get_userdata($cur_user_id);
		if($user_info->user_market == "ГринМаркет ТЦ Море" or $_COOKIE["market"] == "ГринМаркет ТЦ Море") {
		echo "?wms-addon-store-filter-form%5B0%5D=cab1caa9-da10-11eb-0a80-07410026c356";
				...
				<div class="buyoneclick-modal__field buyoneclick-modal__hide" id="buyoneclick-shop">
					<select name="shop">
						<optgroup label="Владивосток">
							...
							<option>Заря (ул. Чкалова, 30)</option>
